...
from aurora import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL, client
...
from aurora.modules.connection import connect_button
...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/CoNqUeRoRmEsKeTtEr/Aurora_queeN)
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/CoNqUeRoRmEsKeTtEr/Aurora_queeN.git)
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/8a0b9c6e4629c2ff36747.jpg"
else:
  img = START_IMG    
    
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("aurora.modules." + module_name)
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚜️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="🛡Contact Creator",url="https://t.me/CoNqUeRoR_mEsKeTteR")]]))
        return
