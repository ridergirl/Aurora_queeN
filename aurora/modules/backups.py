...
from aurora import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, MESSAGE_DUMP
...
from aurora.modules.helper_funcs.msg_types import get_note_type
from aurora.modules.rules import get_rules
import aurora.modules.sql.rules_sql as rulessql
from aurora.modules.sql import warns_sql as warnssql
import aurora.modules.sql.blacklist_sql as blacklistsql
from aurora.modules.sql import disable_sql as disabledsql
from aurora.modules.sql import cust_filters_sql as filtersql
import aurora.modules.sql.welcome_sql as welcsql
...
def export_data(bot: Bot, update: Update, chat_data):
    ...
    f=open("aurora{}.backup".format(chat_id), "w")
