...
if ENV:
    ...
    from Aurora_queeN.config import Development as Config
...
client = TelegramClient("Aurora_queeN", api_id, api_hash)
...
from Aurora_queeN.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
